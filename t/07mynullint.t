...
# columns defined as  "int null".  It really only tests 
...
$sql = "insert into $table values (2000000000) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (defined $value && $value ==  2000000000)
    {
        if ($got_v1)
        {
            die "read 2000000000 twice" ;
        }
        $got_v1 = 1;
    }
    elsif (! defined ($value))
