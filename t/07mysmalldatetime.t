...
# columns defined as  "smalldatetime not null".  It really only tests 
...
$sql = "insert into $table values ('1999-01-31 12:36:00') ";
...
$sql = "insert into $table values ('1900-01-01 00:01:00') ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (! defined($r{"mysmalldatetime"}))
    {
        undef $value;
    }
    else
    {
        $value = $r{"mysmalldatetime"} . " ";
        $value =~ s/ *$//;
    }
    ...
    if (defined $value && $value eq '1999-01-31 12:36:00')
    {
        if ($got_v1)
        {
            die "read '1999-01-31 12:36:00' twice" ;
        }
        $got_v1 = 1;
    }
    elsif (defined $value && $value eq '1900-01-01 00:01:00')
    {
        if ($got_v2)
        {
            die "read '1900-01-01 00:01:00' twice" ;
        }
        $got_v2 = 1;
    }
    else
