...
# columns defined as  "real not null".  It really only tests 
...
$sql = "insert into $table values (0.0) ";
...
$sql = "insert into $table values (-1456.0) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    elsif (defined $value && $value ==  -1456.0)
    {
        if ($got_v2)
        {
            die "read -1456.0 twice" ;
        }
        $got_v2 = 1;
    }
    else
