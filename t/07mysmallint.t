...
# columns defined as  "smallint not null".  It really only tests 
...
$sql = "insert into $table values (257) ";
...
$sql = "insert into $table values (-127) ";
