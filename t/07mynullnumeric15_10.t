...
# columns defined as  "numeric(15:10) null".  It really only tests 
...
my $table = "t007mynullnumeric15_10";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (! defined($r{"mynullnumeric15_10"}))
    {
        undef $value;
    }
    else
    {
        $value = $r{"mynullnumeric15_10"} . " ";
        $value =~ s/ *$//;
    }
