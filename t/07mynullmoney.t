...
# columns defined as  "money null".  It really only tests 
...
$sql = "insert into $table values (999.9999) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (defined $value && $value ==  999.9999)
    {
        if ($got_v1)
        {
            die "read 999.9999 twice" ;
        }
        $got_v1 = 1;
    }
    elsif (! defined ($value))
