...
# columns defined as  "smalldatetime null".  It really only tests 
...
my $table = "t007mynullsmalldatetime";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (! defined($r{"mynullsmalldatetime"}))
    {
        undef $value;
    }
    else
    {
        $value = $r{"mynullsmalldatetime"} . " ";
        $value =~ s/ *$//;
    }
