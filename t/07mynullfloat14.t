...
# columns defined as  "float(14) null".  It really only tests 
...
$sql = "insert into $table values (1234) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (! defined($r{"mynullfloat14"}))
    {
        undef $value;
    }
    else
    {
        $value = $r{"mynullfloat14"} . " ";
        $value =~ s/ *$//;
    }
