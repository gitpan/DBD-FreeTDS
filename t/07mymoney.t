...
# columns defined as  "money not null".  It really only tests 
...
$sql = "insert into $table values (14.12) ";
...
$sql = "insert into $table values (-922337203685477.58) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (defined $value && $value ==  14.12)
    {
        if ($got_v1)
        {
            die "read 14.12 twice" ;
        }
        $got_v1 = 1;
    }
    elsif (defined $value && $value ==  -922337203685477.58)
    {
        if ($got_v2)
        {
            die "read -922337203685477.58 twice" ;
        }
        $got_v2 = 1;
    }
    else
