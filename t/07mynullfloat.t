...
# columns defined as  "float null".  It really only tests 
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (defined $value && $value ==  10247.123)
    {
        if ($got_v1)
        {
