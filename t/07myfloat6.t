...
# columns defined as  "float(6) not null".  It really only tests 
...
$sql = "insert into $table values (7.0) ";
...
$sql = "insert into $table values (-43214.5) ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    elsif (defined $value && $value ==  -43214.5)
    {
        if ($got_v2)
        {
            die "read -43214.5 twice" ;
        }
        $got_v2 = 1;
    }
    else
