...
# columns defined as  "char(10) null".  It really only tests 
...
$sql = "insert into $table values ('1234567890') ";
...
while (defined ($rs = $sth->fetchrow_hashref))
{
    ...
    if (defined $value && $value eq '1234567890')
    {
        if ($got_v1)
        {
            die "read '1234567890' twice" ;
        }
        $got_v1 = 1;
    }
    elsif (! defined ($value))
